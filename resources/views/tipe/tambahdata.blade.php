                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="card-title">
                                            <h3 class="text-center title-2">Tambah Data Tipe</h3>
                                        </div>
                                        <hr>
                                        <form action="{{ route('tipe.store') }}" method="POST" novalidate="novalidate">
                                            {{ csrf_field() }}
                                            <div class="form-group">
                                                <label for="nama_tipe" class="control-label mb-1">Nama Tipe</label>
                                                <input id="nama_tipe" name="nama_tipe" type="text" class="form-control" aria-required="true" aria-invalid="false">
                                            </div>
                                            <div>
