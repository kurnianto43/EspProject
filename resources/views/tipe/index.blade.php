                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            <li><a href="#">Tipe</a></li>
                            <li><a class="active">Data Tipe</a></li>
                        </ol>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title">Data Tipe</strong>
                                <a class="btn btn-primary btn-sm pull-right" href="{{ route('tipe.create') }}"><i class="fa fa-plus"></i> Tambah</a>
                                ...
                                <table id="bootstrap-data-table-export" class="table table-striped table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a class="btn btn-warning btn-sm" href="{{ route('tipe.edit', $tipe) }}"><i class="fa fa-edit"></i> Ubah</a>
