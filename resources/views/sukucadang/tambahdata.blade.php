                            ...
                            <div class="col-lg-8 offset-lg-2">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <hr>
                                        <form action="{{ route('sukucadang.store') }}" method="POST" novalidate="novalidate">
                                            {{ csrf_field() }}
                                            <div class="form-group">
                                                <label for="nomor_suku_cadang" class="control-label mb-1">Nomor Suku Cadang</label>
                                                <input id="nomor_suku_cadang"  name="nomor_suku_cadang" type="text" class="form-control" aria-required="true" aria-invalid="false">
                                            </div>
                                            <div class="form-group">
                                                <label for="nama_suku_cadang" class="control-label mb-1">Nama Suku Cadang</label>
                                                <input id="nama_suku_cadang" name="nama_suku_cadang" type="text" class="form-control" aria-required="true" aria-invalid="false">
                                            </div>
                                            <div class="form-group">
                                                <label for="jumlah_suku_cadang" class="control-label mb-1">Jumlah</label>
                                                <input id="jumlah_suku_cadang" name="jumlah_suku_cadang" type="text" class="form-control" aria-required="true" aria-invalid="false">
                                            </div>
                                            </div>                                           
