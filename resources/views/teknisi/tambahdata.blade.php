                            ...
                            <div class="col-lg-8 offset-lg-2">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <hr>
                                        <form action="{{ route('teknisi.store') }}" method="POST" novalidate="novalidate">
                                            {{ csrf_field() }}
                                            <div class="form-group">
                                                <label for="kode_teknisi" class="control-label mb-1">Kode Teknisi</label>
                                                <input id="kode_teknisi"  name="kode_teknisi" type="text" class="form-control" aria-required="true" aria-invalid="false">
                                            </div>
                                            <div class="form-group">
                                                <label for="nama_teknisi" class="control-label mb-1">Nama Teknisi</label>
                                                <input id="nama_teknisi" name="nama_teknisi" type="text" class="form-control" aria-required="true" aria-invalid="false">
                                            </div>
                                            <div>
